 ...
 */
define("WECHAT_URL", 'https://2.heibaixiaoyuan.com/');
define('WECHAT_TOKEN', 'countdownpartytoken123');
define('ENCODING_AES_KEY', "Ya4WBaYWqUuArqumdQvGKtdANjaRM88gBBcs9VltIPo");

/*
 * 开发者配置
 * 2016.10.17 跨年活动配置
 */
define("WECHAT_APPID", 'wx5d4141534a28eb61');
define("WECHAT_APPSECRET", 'a5ce1535c04f024bbd81782cf94ea388');
